...
namespace ProjetoApi.Controllers
{
    public class ObservacoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ObservacaoDescricao,ObservacaoLocal,ObservacaoData,PessoaId,UsuarioId")] Observacoes observacoes)
        {
            ...
            ViewData["PessoaId"] = new SelectList(_context.Pessoa, "Id", "Id", observacoes.PessoaId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ObservacaoDescricao,ObservacaoLocal,ObservacaoData,PessoaId,UsuarioId")] Observacoes observacoes)
        {
